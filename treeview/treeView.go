...
// 'iFace' = []interface{"github.com", "hfmrow", "gtk3_import", "pango.go"}
// 'iFace' = []interface{"github.com", "hfmrow", "gtk3_import", "main.go"}
// 'iFace' = []interface{"github.com", "hfmrow", "gtk3_import", "view.go"}
